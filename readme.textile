...
Used "mirrorselect":http://en.gentoo-wiki.com/wiki/Mirrorselect to find better mirrors, as @emerge imagemagick@ failed. Tried @emerge =libjpeg-turbo-1.1.1@. Found only @ftp://mirror.switch.ch/mirror/gentoo/distfiles/libjpeg8_8d-1.debian.tar.gz@ emerge searches for @libjpeg8_8c-2.debian.tar.gz@. Question: How do I change the dependency?
