...
After two comments to fix some "missing gems":https://github.com/ngiger/oddb.org/commit/fd1e90931d49b54e7f1a6c41a9a5eb18d467fc77 and parse.y without "magic comment":https://github.com/ngiger/oddb.org/commit/fc2d8e7a795f3ecb08a3e9019b7085ddd49644d1 I proceeded much further.

h3. Still errors in bin/oddb
...
/usr/local/rvm/gems/ruby-1.9.3-p392/gems/paypal-2.0.0/lib/notification.rb:52:in `<class:Notification>': undefined method `cattr_accessor' for Paypal::Notification:Class (NoMethodError)
        from /usr/local/rvm/gems/ruby-1.9.3-p392/gems/paypal-2.0.0/lib/notification.rb:40:in `<module:Paypal>'
        from /usr/local/rvm/gems/ruby-1.9.3-p392/gems/paypal-2.0.0/lib/notification.rb:3:in `<top (required)>'
        from /usr/local/rvm/rubies/ruby-1.9.3-p392/lib/ruby/site_ruby/1.9.1/rubygems/custom_require.rb:36:in `require'
        from /usr/local/rvm/rubies/ruby-1.9.3-p392/lib/ruby/site_ruby/1.9.1/rubygems/custom_require.rb:36:in `require'
        from /usr/local/rvm/gems/ruby-1.9.3-p392/gems/paypal-2.0.0/lib/paypal.rb:30:in `<top (required)>'
        ...
        from /var/www/oddb.org/src/util/oddbapp.rb:31:in `<top (required)>'
        from /usr/local/rvm/rubies/ruby-1.9.3-p392/lib/ruby/site_ruby/1.9.1/rubygems/custom_require.rb:36:in `require'
        from /usr/local/rvm/rubies/ruby-1.9.3-p392/lib/ruby/site_ruby/1.9.1/rubygems/custom_require.rb:36:in `require'
